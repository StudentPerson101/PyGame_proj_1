...
# projectile_1_image_path = # initially hard-coded
# projectile_explosion_1_image_path = # initially hard-coded
# projectile_2_image_path = # initially hard-coded
# projectile_explosion_2_image_path = # initially hard-coded
# projectile_3_image_path = # initially hard-coded
# projectile_explosion_3_image_path = # initially hard-coded
...
# Projectile sizes (can be adjusted manually)
...
def reset_game():
    global game_over, player1, asteroids, invulnerable, invulnerability_start_time, start_time, projectiles, explosions
    game_over = False
