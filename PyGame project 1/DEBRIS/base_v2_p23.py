...
def reset_game():
    global game_over, player1, asteroids, invulnerable, invulnerability_start_time, projectiles, explosions, last_asteroid_group_spawn_time, score
    game_over = False
...
while running:
    ...
    if game_state == 'menu':
        ...
        high_score_text = font_timer.render(f"High Score: {high_score}", True, TEXT_COLOR)
