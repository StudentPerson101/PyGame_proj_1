...
def reset_game():
    global game_over, player1, asteroids, invulnerable, invulnerability_start_time, projectiles, explosions, last_asteroid_group_spawn_time, score, player_health
    game_over = False
...
running = True
game_over = False
game_state = 'menu'  # Possible states: 'menu', 'playing', 'rules', 'game_over', 'paused'
...
while running:
    ...
    if game_state == 'menu':
        ...
        play_music(gameplay_music_path, volume=gameplay_music_volume)  # Play gameplay music
